...
public class scr_SaveController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Debug.Log(input.playerInput.actions.ToJson());
        // testString = input.playerInput.actions.ToJson();
        // input.playerInput.actions.LoadFromJson();
        // input.SaveActionsInPlayerInput();
        
        // input.playerInput.
        // input.playerInput.actions.bindingMask.
    ...
    {
        string path = Application.streamingAssetsPath + "/Saves/saveGame" + numberOfSave+".json";
        string data = JsonUtility.ToJson(newSave, true);
    ...
    public void SetSettingsData(SettingsData newSettings)
    {
        ...
        string path = Application.streamingAssetsPath + "/SettingsData.json";
        string data = JsonUtility.ToJson(newSettings, true);
        File.WriteAllText(path,data);
    }
...
public class SaveGame
{
    ...
    public bool bossFireflyPhase1_firstTry;
    public bool bossFireflyPhase2_stage1_firstTry;
    public string bossFireflyPhase2_stage;
    public bool bossFireflyIsDead;
